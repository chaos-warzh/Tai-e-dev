...
class DynamicConfig {
    ...
    void start() {
        while (true) {
            ...
            System.out.println("Please input the taint config file path:");
            ...
            reset();
            prepare(config);
            logger.info("Start analysis with config: {}", config);
            analyze();

        }
//
//        String config1 = "src/test/resources/pta/taint/taint-config.yml";
//        String config2 = "java-benchmarks/log4j/2.14.0/taint-config.yml";
//
//        reset();
//        prepare(config1);
